                    ...
                    <div className="prose prose-h4:inline prose-ul:mt-0 mx-auto py-1">
                        ...
                        <section id="header">
                            <header>
                                ...
                                <h4>
                                    cspencernd@gmail.com |
                                    linkedin.com/in/cspencernd |
                                    github.com/cspencernd
                                </h4>
                            </header>
                            <p className="font-medium">
                                Meticulously organized, self-taught web developer,
                                with an obsession for sleek ui and a penchant for
                                proper ux and accessiblity.
                            </p>
                            <p>
                                Linux, Mac, Windows | HTML, CSS | JavaScript,
                                TypeScript, React | Python, C, Git
                            </p>
                        </section>
                        <section id="workHistory">
                            ...
                            <ul>
                                <li>
                                    Successfully built and deployed fully
                            ...
                            <ul>
                                <li>
                                    Keyholder, inventory manager. Consistently
                                    exceeded sales goals.
                                </li>
                                <li>
                                    Provided high quality customer service and
                                    technical support.
                                </li>
                            ...
                            <ul>
                                <li>
                                    Responsible for managing inventory; sent and
                                    received inter-store transfers.
                                </li>

                                <li>
                                    Directed stockroom organization, improving
                        ...
                        <section id="education">
                            ...
                            <div>
                                ...
                                <p>
                                    Human Anatomy, Kinesiology, Exercise Science
                                </p>
                            </div>
                        </section>
                    </div>
